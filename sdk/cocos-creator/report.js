!function (e, t) {
    ...
    "object" == typeof module
        ?
        module.exports = t()
        : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.report = t() : e.report = t()
}
(
    {}, function () {
        return function (e) {
            ...
            return n.m = e, n.c = t, n.d = function (e, t, r) {
                ...
                class Or {
                    constructor(serverUrl, appid, appkey, debug) {
                        if (typeof window.ZL_EventReport === 'object') {
                            return window.ZL_EventReport;
                        }
                ...
                vr.EventReport = null, vr.ENUM = null, vr.EventReport = Or, window.report = vr, t.default = vr
            }]
        ).default
    }
);
