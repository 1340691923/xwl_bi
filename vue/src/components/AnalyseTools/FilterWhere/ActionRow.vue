  ...
  <div>
    <div class="ta-filter-condition ">
      ...
      <template v-else-if="rangeSymbolArr.indexOf(v.comparator)!==-1">
        <el-input v-model="v.ftv[0]" clearable size="mini" type="number" style="width: 100px" />~
        <el-input v-model="v.ftv[1]" clearable size="mini" type="number" style="width: 100px" />
      </template>

      <el-input v-else-if="inputSymbolArr.indexOf(v.comparator)!==-1" v-model="v.ftv" clearable size="mini" style="width: 100px" />
      ...
      <template v-else>
        <keep-alive>
          <select-values ref="values" v-model="v.ftv" :table-typ="tableTyp" style="width: 150px" :data="v.columnName" />
        </keep-alive>
      </template>
